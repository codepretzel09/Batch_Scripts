...
for /F %%a in (pclist.txt) do (
	...
	wmic /user:administrator /password:Student99 /Failfast:on /node:"%%a" /output:"%%a_productid.html" csproduct list full /format:hform
	wmic /user:administrator /password:Student99 /Failfast:on /node:"%%a" /output:"%%a_OS.html" OS Get /All /format:hform
	wmic /user:administrator /password:Student99 /Failfast:on /node:"%%a" /output:"%%a_system.html" COMPUTERSYSTEM list BRIEF /format:hform
	wmic /user:administrator /password:Student99 /Failfast:on /node:"%%a" /output:"%%a_qfe.html" QFE where "Description<>''" Get /All /format:htable
	wmic /user:administrator /password:Student99 /Failfast:on /node:"%%a" /output:"%%a_drives.html" logicaldisk get caption, description, filesystem, size, freespace, compressed /format:htable
	wmic /user:administrator /password:Student99 /Failfast:on /node:"%%a" /output:"%%a_motherboard.html" BASEBOARD list FULL /format:htable
	wmic /user:administrator /password:Student99 /Failfast:on /node:"%%a" /output:"%%a_bios.html" BIOS list brief /format:htable
	wmic /user:administrator /password:Student99 /Failfast:on /node:"%%a" /output:"%%a_nic.html" NIC list brief /format:htable
	wmic /user:administrator /password:Student99 /Failfast:on /node:"%%a" /output:"%%a_services.html" SERVICE list brief /format:htable
	wmic /user:administrator /password:Student99 /Failfast:on /node:"%%a" /output:"%%a_users.html" USERACCOUNT list brief /format:htable
	wmic /user:administrator /password:Student99 /Failfast:on /node:"%%a" /output:"%%a_slot.html" SYSTEMSLOT list brief /format:htable
