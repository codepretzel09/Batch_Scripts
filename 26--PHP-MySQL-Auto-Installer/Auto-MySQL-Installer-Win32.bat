...
msiexec /i %mysql_msi% /qn INSTALLDIR="C:\Program Files\MySQL\MySQL Server 5.1\"
"C:\Program Files\MySQL\MySQL Server 5.1\bin\mysqlinstanceconfig.exe" -i -q ServiceName=MySQL RootPassword=mysql ServerType=DEVELOPMENT DatabaseType=MYISAM Port=3306 RootCurrentPassword=mysql

rem ***********************************************
rem comment next line to prevent root access from any pc...
rem "C:\Program Files\MySQL\MySQL Server 5.1\bin\mysql.exe" -uroot -pmysql -e %mysql_cmd%
rem ***********************************************
...
regedit /s %installdrive%\MySQL-DSN-32-64bit.reg
regedit /s %installdrive%\MySQL-DSN-WOW6432-32bit.reg
...
echo.
@ping localhost
start "" "C:\Program Files\Internet Explorer\iexplore.exe" http://127.0.0.1/default.php
start "" "C:\Program Files\Internet Explorer\iexplore.exe" http://127.0.0.1/phpMyAdmin/index.php
cls
echo.
